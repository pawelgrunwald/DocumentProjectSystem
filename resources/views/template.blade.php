  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-text-color navbar-bg-color">
      <a class="navbar-brand" href="{{ URL::to('/home') }}">
        <img src="{{ URL::asset('media/images/logo-project-system-1.png') }}" alt="Document Project System">
      </a>
      <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarNav" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
        <span class="navbar-toggler-icon"><img src="{{ URL::asset('media/images/nav.png') }}" alt="Nawigacja"></span>
      </button>
          ...
          <!-- Right Side Of Navbar -->
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="{{  URL::to('projects/') }}">Projekty</a>
                            </li>
                              ...
                              <li class="nav-item dropdown position-text">
                                  ...
                                  <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                      <ul class="dropdown-nav">
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{  URL::to('profile/'.Auth::user()->name.'/') }}">Moje dane</a>
                                        </li>
                                      </ul>
